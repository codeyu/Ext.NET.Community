...
namespace Ext.Net
{
    ...
    public partial class ChartDirectEvents : AbstractComponentDirectEvents
    {
        ...
        public virtual ComponentDirectEvent BeforeRefresh
        {
            get
            {
                return this.beforerefresh ?? (this.beforerefresh = new ComponentDirectEvent());
            }
        }
        ...
        public virtual ComponentDirectEvent Refresh
        {
            get
            {
                return this.refresh ?? (this.refresh = new ComponentDirectEvent());
            }
        }
        ...
        public virtual ComponentDirectEvent Select
        {
            get
            {
                return this.select ?? (this.select = new ComponentDirectEvent());
            }
        }
    }
}
