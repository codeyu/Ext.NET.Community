    ...
    public partial class DesktopModuleProxy
    {
        ...
        public partial class Builder : BaseControl.Builder<DesktopModuleProxy, DesktopModuleProxy.Builder>
        {
			...
			/// 
 			...
 			/// <returns>An instance of DesktopModuleProxy.Builder</returns>
            public virtual DesktopModuleProxy.Builder Module(Action<DesktopModule> action)
            {
                action(this.ToComponent().Module);
